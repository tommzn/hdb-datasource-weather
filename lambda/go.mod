module github.com/tommzn/hdb-datasource-weather/lambda
...
require (
	...
	github.com/tommzn/hdb-datasource-weather v1.0.16
)
...
require (
	...
	github.com/tommzn/hdb-events-go v1.0.15 // indirect
